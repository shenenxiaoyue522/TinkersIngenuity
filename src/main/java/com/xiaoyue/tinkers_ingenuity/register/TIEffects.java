...
public class TIEffects {
    ...
    public static final RegistryEntry<DeadlyPlague> DEADLY_PLAGUE = effect("deadly_plague", DeadlyPlague::new,
    ...
    private static <T extends MobEffect> RegistryEntry<T> effect(String name, NonNullSupplier<T> sup, String desc) {
        return TinkersIngenuity.REGISTRATE.getExtra().simpleEffect(name, sup, desc).register();
    }
