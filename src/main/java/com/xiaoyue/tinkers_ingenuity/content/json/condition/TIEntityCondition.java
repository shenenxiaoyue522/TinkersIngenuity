...
public class TIEntityCondition {
    ...
    public static final LivingEntityPredicate IN_WATER_OR_RAIN = LivingEntityPredicate.simple(Entity::isInWaterOrRain);
    ...
    public static void registerPredicate() {
        ...
        LivingEntityPredicate.LOADER.register(TinkersIngenuity.loc("in_water_or_rain"), IN_WATER_OR_RAIN.getLoader());
    }
}
